...
export default function CustomRugBanner({
  ...
  description = "Share a photo or concept — we’ll design, tuft, and ship it worldwide.",
        ...
        <div className="relative overflow-hidden rounded-3xl border border-[#e8e0d6] bg-[#fbf8f2] shadow-[0_18px_50px_rgba(0,0,0,0.06)]">
              ...
              <div className="absolute inset-0 flex items-center justify-center px-8">
                <div className="relative h-[320px] w-full max-w-[520px]">
                  ...
                  <div className="absolute left-0 top-6 w-[48%] rotate-[-2deg]">
                    <div className="rounded-3xl border border-[#e8e0d6] bg-white/70 p-3 shadow-[0_18px_50px_rgba(0,0,0,0.10)] backdrop-blur">
                  ...
                  <svg
                    ...
                    style={{
                      width: 140, // ✅ adjust size here
                      height: 140, // ✅ adjust size here
          ...
          <div className="relative grid grid-cols-1 gap-10 px-6 py-10 sm:px-10 sm:py-12 lg:grid-cols-2 lg:gap-6">
            ...
            <div className="max-w-xl">
              {/* badge */}
              <span className="inline-flex items-center rounded-full border border-[#e3d6c7] bg-white/70 px-3 py-1 text-[12px] font-semibold tracking-[0.18em] text-[#5a463a]">
                {subtitle}
              </span>
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {chips.map((chip) => (
                  <span
                    key={chip}
                    className="inline-flex items-center rounded-full border border-[#eadfce] bg-white/70 px-3 py-1 text-sm text-[#574b45]"
                  >
                    {chip}
                  </span>
                ))}
