...
const Login = ({ setCurrentView }: Props) => {
  ...
  // Track successful email login (message becomes undefined after success)
  useEffect(() => {
    if (hasSubmitted.current && message === undefined) {
      trackLogin("email")
    }
    if (message !== null) {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setGoogleError(error.message || "Failed to login with Google")
      setGoogleLoading(false)
    }
  }
  ...
  return (
    ...
    >
      ...
      <p className="text-center text-base-regular text-ui-fg-base mb-8">
        Sign in to be part of the RuggyLand story.
      </p>
