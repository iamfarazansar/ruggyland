    ...
    <Wrapper>
      <div className=" mx-auto p-8">
        <div className="bg-white rounded-lg shadow-lg">
          ...
          <h2 className="text-2xl font-bold text-center py-6">Overview</h2>
          <p className="text-lg px-6 py-4">
            This website is operated by RuggyLand. Throughout the site, the
            terms “we”, “us” and “our” refer to RuggyLand. RuggyLand offers this
          ...
          <p className="text-lg px-6 py-4">
            In no case shall RuggyLand, our directors, officers, employees,
          ...
          <p className="text-lg px-6 py-4">
            You agree to indemnify, defend and hold harmless RuggyLand and our
          ...
          <p className="text-lg px-6 py-4">
            ...
            <a href="mailto:ruggyland@gmail.com">ruggyland@gmail.com</a>. <br />{" "}
