...
import { CustomerCreatedTemplate, CUSTOMER_CREATED, isCustomerCreatedTemplateData } from './customer-created'
...
export { InviteUserEmail, OrderPlacedTemplate, CustomerCreatedTemplate }
